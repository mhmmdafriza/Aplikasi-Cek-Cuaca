...
# Deskripsi
Aplikasi Cek Cuaca adalah sebuah aplikasi desktop sederhana yang memungkinkan pengguna untuk mendapatkan informasi cuaca terkini berdasarkan lokasi yang diinginkan. Aplikasi ini dirancang menggunakan Java dan antarmuka berbasis GUI (Graphical User Interface) dengan framework seperti JFrame, sehingga mudah digunakan oleh berbagai kalangan pengguna.

## Coding Java Frame Aplikasi Cek Cuaca
```java
